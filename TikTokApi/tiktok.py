...
class TikTokApi:
    ...
    def discoverHashtags(self, **kwargs) -> dict:
        ...
        b = browser(api_url, **kwargs)
        return self.getData(b, **kwargs)["body"][1][
            "exploreList"
        ]
    ...
    def discoverMusic(self, **kwargs) -> dict:
        ...
        b = browser(api_url, **kwargs)
        return self.getData(b, **kwargs)["body"][2][
            "exploreList"
        ]
    ...
    def getSuggestedUsersbyID(
        ...
        res = []
        b = browser(api_url, **kwargs)
        for x in self.getData(b, **kwargs)["body"][0][
            "exploreList"
        ]:
    ...
    def getSuggestedHashtagsbyID(
        ...
        res = []
        b = browser(api_url, **kwargs)
        for x in self.getData(b, **kwargs)["body"][1][
            "exploreList"
        ]:
            res.append(x["cardItem"])
        return res[:count]
    ...
    def getSuggestedMusicbyID(
        ...
        res = []
        b = browser(api_url, **kwargs)
        for x in self.getData(b, **kwargs)["body"][2][
            "exploreList"
        ]:
            res.append(x["cardItem"])
        return res[:count]
